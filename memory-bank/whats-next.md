...
2. **Vault engine**: reader (frontmatter + wikilink parse), chokidar watcher, notes_index + links tables, `npm run reindex`. Tests: parse, link extraction, rebuild-from-vault.
